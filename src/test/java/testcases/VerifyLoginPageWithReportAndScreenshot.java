...
public class VerifyLoginPageWithReportAndScreenshot 
{
	...
	public void testLoginPage()
	{
        ...
        logger.log(LogStatus.INFO, logger.addScreenCapture(Helper.captureScreeshot(driver, "validate2")));
    ...
    public void tearDown(ITestResult result)
    {
    	...
    	{
    	   String path=Helper.captureScreeshot(driver,result.getName());
    	  // logger.log(LogStatus.FAIL,logger.addScreenCapture(path));
    	   logger.log(LogStatus.FAIL, logger.addScreenCapture(Helper.captureScreeshot(driver, "validate2")));
